...
class LsdSwirl : Form
{
    ...
    private Bitmap canvas = new Bitmap(1280, 720, PixelFormat.Format24bppRgb);
    private int canvasWidth = 1280, canvasHeight = 720;
    private Point lastMousePosition;
    private byte[] vars = new byte[1280 * 720];
    ...
    public LsdSwirl()
    {
        ...
        canvas = new Bitmap(1280, 720, PixelFormat.Format24bppRgb);
